...
# batocera - add amd, freedreno, intel_hasvk & panfrost
# Vulkan Drivers
...
ifneq ($(BR2_PACKAGE_MESA3D_GALLIUM_DRIVER_R600)$(BR2_PACKAGE_MESA3D_GALLIUM_DRIVER_RADEONSI)$(BR2_PACKAGE_MESA3D_GALLIUM_DRIVER_NOUVEAU)$(BR2_PACKAGE_MESA3D_GALLIUM_DRIVER_VIRGL),)
...
HOST_MESA3D_INSTALL_PANFROST_COMPILE = \
	$(INSTALL) -D -m 0755 $(@D)/build/src/panfrost/clc/panfrost_compile $(HOST_DIR)/bin/panfrost_compile
endif
