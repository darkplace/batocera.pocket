...
E2FSPROGS_TARGET_CFLAGS += -Os
endif

ifeq ($(BR2_TOOLCHAIN_GCC_AT_LEAST_15),y)
E2FSPROGS_TARGET_CFLAGS += -std=gnu17
endif

ifneq ($(E2FSPROGS_TARGET_CFLAGS),)
E2FSPROGS_CONF_ENV += CFLAGS="$(TARGET_CFLAGS) $(E2FSPROGS_TARGET_CFLAGS)"
endif
