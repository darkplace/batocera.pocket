...
# FEX guest thunk builds need an x86/x86_64-capable host clang even on
# aarch64 targets. Only the host toolchain needs this extra backend.
ifeq ($(BR2_PACKAGE_FEX_EMU),y)
HOST_LLVM_TARGETS_TO_BUILD += X86
endif
