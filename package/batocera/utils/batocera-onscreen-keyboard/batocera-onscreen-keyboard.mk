...
define BATOCERA_ONSCREEN_KEYBOARD_INSTALL_TARGET_CMDS
	...
	# Optional Odin2 helper: toggle OSK on HOTKEY + touchscreen tap
	$(INSTALL) -D -m 0755 $(BATOCERA_ONSCREEN_KEYBOARD_PATH)/sources/onscreen-keyboard-hotkey-touch.py \
		$(TARGET_DIR)/usr/bin/onscreen-keyboard-hotkey-touch
	$(INSTALL) -D -m 0755 $(BATOCERA_ONSCREEN_KEYBOARD_PATH)/S91onscreen-keyboard-hotkey-touch \
		$(TARGET_DIR)/etc/init.d/S91onscreen-keyboard-hotkey-touch
