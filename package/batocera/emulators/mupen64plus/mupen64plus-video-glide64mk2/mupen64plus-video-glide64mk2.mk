...
define MUPEN64PLUS_VIDEO_GLIDE64MK2_REMOVE_STALE_DEPS
	$(RM) -r $(@D)/projects/unix/_obj
endef
...
MUPEN64PLUS_VIDEO_GLIDE64MK2_PRE_BUILD_HOOKS += MUPEN64PLUS_VIDEO_GLIDE64MK2_REMOVE_STALE_DEPS
