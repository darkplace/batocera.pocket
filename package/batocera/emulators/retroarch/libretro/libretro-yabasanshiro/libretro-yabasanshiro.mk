...
define LIBRETRO_YABASANSHIRO_FIX_LINE_ENDINGS
	sed -i -e 's/\r$$//' $(@D)/yabause/src/yabause.c
endef

LIBRETRO_YABASANSHIRO_PRE_PATCH_HOOKS += LIBRETRO_YABASANSHIRO_FIX_LINE_ENDINGS
