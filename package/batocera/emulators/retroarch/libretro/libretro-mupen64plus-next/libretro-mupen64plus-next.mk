...
else ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_QCS6490)$(BR2_PACKAGE_BATOCERA_TARGET_SM8250)$(BR2_PACKAGE_BATOCERA_TARGET_SM8X50),y)
...
ifeq ($(BR2_PACKAGE_BATOCERA_TARGET_SM8X50)$(BR2_PACKAGE_VULKAN_HEADERS)$(BR2_PACKAGE_VULKAN_LOADER),yyy)
LIBRETRO_MUPEN64PLUS_NEXT_DEPENDENCIES += vulkan-headers vulkan-loader
LIBRETRO_MUPEN64PLUS_NEXT_EXTRA_ARGS += HAVE_PARALLEL_RSP=1 HAVE_PARALLEL_RDP=1 HAVE_THR_AL=1 LLE=1
endif
